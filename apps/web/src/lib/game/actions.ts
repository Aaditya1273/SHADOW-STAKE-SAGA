...
export const preload = (scene: Phaser.Scene) => {
  ...
  // Load all enemies as spritesheets with 4 frames each
  scene.load.spritesheet('skeleton', `/dungeon/enemies/skeleton.png`, {
    frameWidth: 16,
    frameHeight: 16,
  });
  scene.load.spritesheet('archer', `/dungeon/enemies/archer.png`, {
    frameWidth: 16,
    frameHeight: 16,
  });
  
  // New enemies - divide width by 4 frames
  scene.load.spritesheet('shadow-beast', `/dungeon/enemies/shadow-beast.png`, {
    frameWidth: 22,  // 90/4 ≈ 22 (rounded down)
    frameHeight: 30,
  });
  scene.load.spritesheet('elemental-wraith', `/dungeon/enemies/elemental-wraith.png`, {
    frameWidth: 39,  // 157/4 ≈ 39 (rounded down)
    frameHeight: 50,
  });
  scene.load.spritesheet('necromancer', `/dungeon/enemies/necromancer.png`, {
    frameWidth: 20,  // 80/4 = 20 exactly!
    frameHeight: 21,
  });
