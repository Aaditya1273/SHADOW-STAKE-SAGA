...
export const enemies: EnemyType[] = [
  {
    ...
    weight: 30,
    maxHealth: 50,
    dps: 1.025, // Increased by 0.25% from 1
    movementSpeed: 100,
    attackCooldown: 2000,
    pointsOnKill: 100,
    maxDistance: 200,
  ...
  },
  {
    ...
    weight: 10,
    maxHealth: 100,
    dps: 5.0125, // Increased by 0.25% from 5
    movementSpeed: 70,
    attackCooldown: 3000,
    pointsOnKill: 150,
    maxDistance: 300,
  ...
  },
  {
    ...
    weight: 8,
    maxHealth: 80,
    dps: 8.02, // Increased by 0.25% from 8
    movementSpeed: 150,
    attackCooldown: 2500,
    pointsOnKill: 200,
    maxDistance: 250,
  ...
  {
    key: 'elemental-wraith',
    weight: 6,
    maxHealth: 120,
    dps: 10.025, // Increased by 0.25% from 10
    movementSpeed: 60,
    attackCooldown: 4000,
    pointsOnKill: 250,
    maxDistance: 350,
  ...
  },
  {
    ...
    weight: 4,
    maxHealth: 150,
    dps: 3.0075, // Increased by 0.25% from 3
    movementSpeed: 50,
    attackCooldown: 5000,
    pointsOnKill: 300,
    maxDistance: 300,
